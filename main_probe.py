...
from model.process_clip import insert_adapters
...
def main(args):
    ...
    config = AutoConfig.from_pretrained('/data/develop/smallz/TLV-Core/CLIP-ViT-L-14-DataComp.XL-s13B-b90K/config.json')
    print(args)

    model = TactileProbe(args, config, 1, False, 1)

    if args.load_from_clip:
        load_dir = '/data/develop/smallz/TLV-Core/CLIP-ViT-L-14-DataComp.XL-s13B-b90K/pytorch_model.bin'
