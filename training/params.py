...
def parse_args(args):
    ...
    ###################################
    # beta decay
    parser.add_argument("--beta-init", type=float, default=0.2, help="proportion rate used in curiculum learning")
    parser.add_argument("--beta-end", type=float, default=0.1, help="proportion rate used in curiculum learning")
    parser.add_argument("--span", type=float, default=0.3, help="span of curriculum learning on play")
    parser.add_argument("--inte-type", type=str, default="above", choices=['above', 'below'])
    parser.add_argument("--decay-type", type=str, default='linear', help=['linear', 'exp', 'cosine'])
    ...
    parser.add_argument("--num-sensors", type=int, default=1, help="",)
    ...
    ############################
    # Adapter
    parser.add_argument("--use_shared_adapter", action='store_true', help="Whether to run eval on the dev set.")
    parser.add_argument('--adapter_shared_dim', type=int, default=32, help='')
    ...
    parser.add_argument(
        "--train-data",
        type=str,
        default="dataset/train/touch100k/data_list.json",
